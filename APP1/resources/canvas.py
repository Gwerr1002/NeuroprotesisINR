...
class QMatplotlibCanvas(FigureCanvasQTAgg):
    ...
    """
    def __init__(self, parent=None, dpi=90, *args, **kwargs):
        """
    ...
    def setupCanvas(self, gridspec=(1, 1), axes=[(0, 1, 0, 1)], toolbar=False, x_label = ""):
        ...
        self.axes = [self.fig.add_subplot(gs[ri:rf+1,ci:cf+1],xlabel = "tiempo [seg]", ylabel = "Corriente [mA]") for ri,rf,ci,cf in axes]
