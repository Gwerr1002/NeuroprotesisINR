...
class RPI_cntrl():
	def __init__(self,v1=.5,v2=.5,v3=.5,v4=.5):
		...
		self.IN = [] #lista de objetos dedicados a las interrupciones
		self.confGPIO()
	...
	def interrupciones(self,accion,debounce = 200):
        ...
        accion : function
				...
				en dónde se detecta la interrupción.
        ...
        None.
		"""
		flanco = [GPIO.RISING,GPIO.RISING,GPIO.FALLING,GPIO.FALLING]
		for i in range(4):
			self.IN.append(GPIO.add_event_detect(self.FSR[i],flanco[i],accion,debounce))
