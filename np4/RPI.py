...
class RPI_cntrl():
	...
	def interrupciones(self,accion,debounce = 200):
		self.IN1 = GPIO.add_event_detect(self.FSR_1,GPIO.RISING,accion,debounce)
		self.IN2 = GPIO.add_event_detect(self.FSR_2,GPIO.RISING,accion,debounce)
		self.IN3 = GPIO.add_event_detect(self.FSR_3,GPIO.RISING,accion,debounce)
		self.IN4 = GPIO.add_event_detect(self.FSR_4,GPIO.RISING,accion,debounce)
